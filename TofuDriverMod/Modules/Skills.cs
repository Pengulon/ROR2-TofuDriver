...
namespace TofuDriverMod.Modules
{
    internal static class Skills
    {
        ...
        internal static void CreateSkillFamilies(GameObject targetPrefab)
        {
            ...
            {
                TofuDriverPlugin.DestroyImmediate(obj);
            }
            ...
            typeof(GenericSkill)
                .GetField("_skillFamily", BindingFlags.Instance
                         | BindingFlags.Public | BindingFlags.NonPublic)
                .SetValue(skillLocator.primary, primaryFamily);
            ...
            typeof(GenericSkill)
                .GetField("_skillFamily", BindingFlags.Instance
                         | BindingFlags.Public | BindingFlags.NonPublic)
                .SetValue(skillLocator.secondary, secondaryFamily);

            /*typeof(GenericSkill)
                .GetField("skillFamily", System.Reflection.BindingFlags.Instance)
                .SetValue(skillLocator.secondary.skillFamily, secondaryFamily);*/
            ...
            typeof(GenericSkill)
                .GetField("_skillFamily", BindingFlags.Instance
                         | BindingFlags.Public | BindingFlags.NonPublic)
                .SetValue(skillLocator.utility, utilityFamily);
            ...
            typeof(GenericSkill)
                .GetField("_skillFamily", BindingFlags.Instance
                         | BindingFlags.Public | BindingFlags.NonPublic)
                .SetValue(skillLocator.special, specialFamily);
