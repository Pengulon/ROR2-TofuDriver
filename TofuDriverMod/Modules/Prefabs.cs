...
namespace TofuDriverMod.Modules
{
    ...
    internal static class Prefabs
    {
        ...
        {
            string fullNameString = TofuDriverPlugin.developerPrefix + "_" + namePrefix + "_BODY_NAME";
            string fullDescString = TofuDriverPlugin.developerPrefix + "_" + namePrefix + "_BODY_DESCRIPTION";
            string fullOutroString = TofuDriverPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FLAVOR";
            string fullFailureString = TofuDriverPlugin.developerPrefix + "_" + namePrefix + "_BODY_OUTRO_FAILURE";
        ...
        {
            TofuDriverPlugin.DestroyImmediate(main.transform.Find("ModelBase").gameObject);
            TofuDriverPlugin.DestroyImmediate(main.transform.Find("CameraPivot").gameObject);
            TofuDriverPlugin.DestroyImmediate(main.transform.Find("AimOrigin").gameObject);
        ...
        internal static void SetupCharacterModel(GameObject prefab, CustomRendererInfo[] rendererInfo, int mainRendererIndex)
        {
            ...
            var baseSkinMeshRenderer = characterModel.baseRendererInfos[mainRendererIndex].renderer.GetComponent<SkinnedMeshRenderer>();
            typeof(CharacterModel)
                .GetField("mainSkinnedMeshRenderer", BindingFlags.Instance
                         | BindingFlags.Public | BindingFlags.NonPublic)
                .SetValue(characterModel, baseSkinMeshRenderer);
        ...
        private static void SetupCameraTargetParams(GameObject prefab)
        {
            ...
            CameraTargetParams.AimRequest request = cameraTargetParams.RequestAimType(CameraTargetParams.AimType.Standard);
