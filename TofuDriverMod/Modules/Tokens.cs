...
namespace TofuDriverMod.Modules
{
    internal static class Tokens
    {
        ...
        {
            #region Henry
            string prefix = TofuDriverPlugin.developerPrefix + TofuDriverPlugin.bodyPrefix + "_";
            ...
            LanguageAPI.Add(prefix + "PRIMARY_SHOOTTOFU_NAME", "Shoot Tofu");
            LanguageAPI.Add(prefix + "PRIMARY_SHOOTTOFU_DESCRIPTION", Helpers.agilePrefix + "Shoot Tofu description goes here");
            #endregion
            ...
            LanguageAPI.Add(prefix + "SECONDARY_DRIFT_NAME", "Drift");
            LanguageAPI.Add(prefix + "SECONDARY_DRIFT_DESCRIPTION", Helpers.agilePrefix + "Drift description goes here");
            #endregion
