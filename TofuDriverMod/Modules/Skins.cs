...
namespace TofuDriverMod.Modules
{
    ...
    {
        internal static SkinDef CreateSkinDef(string skinName, Sprite skinIcon, CharacterModel.RendererInfo[] rendererInfos, GameObject root)
        {
            return CreateSkinDef(skinName, skinIcon, rendererInfos, root, null);
        }

        internal static SkinDef CreateSkinDef(string skinName, Sprite skinIcon, CharacterModel.RendererInfo[] rendererInfos, GameObject root, UnlockableDef unlockableDef)
        {
