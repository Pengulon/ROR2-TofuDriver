...
namespace TofuDriverMod.Modules.Survivors
{
    internal class TofuDriver : SurvivorBase
    {
        ...
        internal override BodyInfo bodyInfo { get; set; } = new BodyInfo
        {
            armor = 20f,
            armorGrowth = 0f,
            //body name hard coded because of static not set
            bodyName = "TofuDriverBody",
            bodyNameToken = TofuDriverPlugin.developerPrefix + TofuDriverPlugin.bodyPrefix + "_NAME",
        ...
        internal override void InitializeHitboxes()
        {
            ...
            Transform hitboxTransform = childLocator.FindChild("DriftHitbox");
            Modules.Prefabs.SetupHitbox(model, hitboxTransform, "Drift");
        }
        ...
        internal override void InitializeSkills()
        {
            ...
            #region Secondary 
            string driftSecondaryIdentifier = "SECONDARY_DRIFT";
            SkillDef driftSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo()
            {
                skillName = prefix + TofuDriverPlugin.bodyPrefix + "_" + driftSecondaryIdentifier + "_NAME",
                skillNameToken = prefix + TofuDriverPlugin.bodyPrefix + "_" + driftSecondaryIdentifier + "_NAME",
            ...
            Modules.Skills.AddSecondarySkills(bodyPrefab, driftSkillDef);
            #endregion

            #region Utility
            SkillDef rollSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + TofuDriverPlugin.bodyPrefix + "_UTILITY_ROLL_NAME",
                skillNameToken = prefix + TofuDriverPlugin.bodyPrefix + "_UTILITY_ROLL_NAME",
                skillDescriptionToken = prefix + TofuDriverPlugin.bodyPrefix + "_UTILITY_ROLL_DESCRIPTION",
            ...
            {
                skillName = prefix + TofuDriverPlugin.bodyPrefix + "_SPECIAL_BOMB_NAME",
                skillNameToken = prefix + TofuDriverPlugin.bodyPrefix + "_SPECIAL_BOMB_NAME",
                skillDescriptionToken = prefix + TofuDriverPlugin.bodyPrefix + "_SPECIAL_BOMB_DESCRIPTION",
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(TofuDriverPlugin.developerPrefix + TofuDriverPlugin.bodyPrefix + "_DEFAULT_SKIN_NAME",
            ...
            /* #region MasterySkin
             ...
             SkinDef masterySkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + HenryPlugin.bodyPrefix + "_MASTERY_SKIN_NAME",
...
localScale = new Vector3(0.1233F, 0.1233F, 0.1233F),
        ...
        private static CharacterModel.RendererInfo[] SkinRendererInfos(CharacterModel.RendererInfo[] defaultRenderers, Material[] materials)
        {
            ...
            {
                var m = materials[i];
                if (i < newRendererInfos.Length)
                {
                    newRendererInfos[i].defaultMaterial = m;
                }
                else
                {
                    Debug.Log("skin renderer infos, array mismatch, renders: " + newRendererInfos.Length + ", materials: " + materials.Length);
                    break;
                }
            }
