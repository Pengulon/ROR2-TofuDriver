...
namespace TofuDriverMod.Modules
{
    internal static class Assets
    {
        ...
        private const string assetbundleName = "tofudriverbundle";
        ...
        internal static void LoadAssetBundle()
        {
            ...
            {
                using (var assetStream = Assembly.GetExecutingAssembly().GetManifestResourceStream("TofuDriverMod." + assetbundleName))
                {
        ...
        {
            using (Stream manifestResourceStream2 = Assembly.GetExecutingAssembly().GetManifestResourceStream("TofuDriverMod.TofuDriverBank.bnk"))
            {
